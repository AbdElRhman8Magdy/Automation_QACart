...
List <WebElement> liist = driver.findElements(By.xpath("//ul[@class='course-list']//li"));
        ...
        WebElement scrollto = driver.findElement(By.xpath("//input[@class='btn btn-primary right-click double-click']"));
        ...
        WebElement UploadBtn = driver.findElement(By.cssSelector(".cursor-pointer"));
        UploadBtn.click();
       Thread.sleep(2000);
        Robot rb = new Robot();
...
Thread.sleep(2000);
        String Uploaded = driver.findElement(By.xpath("//*[@for=\"upload-expiration\"]")).getText();
